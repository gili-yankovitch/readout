...
WRITE_SECTION?=flash
SYSTEM_C?=vendor/wch/ch32v/ch32v003fun.c vendor/wch/framework/bsp.c vendor/wch/ch32v/prot.c

CFLAGS:=$(CFLAGS) -g -Os -flto -ffunction-sections -fdata-sections -fmessage-length=0 -msmall-data-limit=8 -Ivendor/wch/ch32v/include/ -Ivendor/wch/framework/include/

ifeq ($(TARGET_MCU),CH32V003)
	CFLAGS_ARCH+=-march=rv32ec -mabi=ilp32e -DCH32V003=1
	GENERATED_LD_FILE?=vendor/wch/ch32v/generated_ch32v003.ld
	TARGET_MCU_LD:=0
	...
	LDFLAGS+=-lgcc
	GENERATED_LD_FILE:=vendor/wch/ch32v/generated_$(TARGET_MCU_PACKAGE).ld
	LINKER_SCRIPT:=$(GENERATED_LD_FILE)
endif
...
$(GENERATED_LD_FILE) :
	$(PREFIX)-gcc -E -P -x c -DTARGET_MCU=$(TARGET_MCU) -DMCU_PACKAGE=$(MCU_PACKAGE) -DTARGET_MCU_LD=$(TARGET_MCU_LD) vendor/wch/ch32v/ch32v003fun.ld > $(GENERATED_LD_FILE)
